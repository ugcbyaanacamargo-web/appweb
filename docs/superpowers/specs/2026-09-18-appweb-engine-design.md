...
- `anthropics/skills` — large public Agent Skills collection and specification examples.
...
- `stackblitz-labs/bolt.diy` — open-source full-stack web-app builder.
...
7. Keep the root repository lightweight enough to manage even though recursive submodule checkout can be large.
...
- All eight upstream repositories are represented as valid Git submodules.
